...
import 'package:untitled2/login/widget/custom_clippers/brown_top_clipper.dart';
import 'package:untitled2/login/widget/custom_clippers/gold_top_clipper.dart';
import 'package:untitled2/login/widget/custom_clippers/lightgold_top_clipper.dart';
import '../../constants.dart';
import '../Register/register.dart';
import '../dashboard/dashboard_screen.dart';
import '../onboarding_screen/widget/header.dart';
import 'dart:convert';
...
class _LoginState extends State<Login>
{
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Login here using your username and password.',
                          style: Theme.of(context).textTheme.titleSmall!.copyWith(color: kDarkBrown.withOpacity(0.7)),
                        ),
  ...
  void checklogin() async
  {
    ...
    else
    {
      ...
      sharedPreferences.setString('name', username.text.toString());
